...
public class PlaceHolderHelper {
	...
	public void placeholdersScanner(StringBuilder sBuilder, int startIndex, Object obj){
		...
		if (index != -1){
			...
			String replace = parseValueStr(obj, cache.toString());
			if (replace != null){
	...
	public void placeholdersBlankScanner(StringBuilder sBuilder, Object params){
		...
		for(int pre = 0; pre < defaultLen; pre ++){
			...
			if(StringUtils.isBlank(express) || StringUtils.isNumeric(express)) continue;
			String value = null;
			if((value = parseValueStr(params, express.trim())) != null){
				datas[pre] = value;
			}
		}
	 ...
	 * @return
	 */
	public String parseValueStr(Object obj, String cache){
		Object result = parseValue(obj, cache);
		if(result == null) return null;
		return String.valueOf(result);
	}

	public Object parseValue(Object obj, String cache){
	...
	public Object parseExpress(Object obj, String express){
		express = express.replace(this.placeholderPrefix, "");
		express = express.replace(this.placeholderSuffix, "");
		return parseValue(obj, express);
	}
